...
import br.edu.ifpb.esperanca.daw2.psicologando.interfaces.PsicologandoConcreto;
...
public class Testes {
  ...
  void  cadastrarUsu() {
   ...
   @Test
    void  enviarRelato() {
      Psicologando d = (Psicologando) new Mural();
   ...
   @Test
    void  ediTarMural() {
      Psicologando e = (Psicologando) new Mural();
      Mural mural = new Mural();
      Psicologo psicologo  =  new Psicologo();
   ...
   @Test
    void  addHoraMedicamento() {
      Psicologando f = new PsicologandoConcreto();
   ...
   @Test
     void IndicarPontoMaisProximo(){
       Psicologando g = new PsicologandoConcreto();
   ...
   @Test
    void addTerapia(){
        Psicologando h = new PsicologandoConcreto();
